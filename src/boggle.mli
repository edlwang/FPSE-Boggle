...
module Boggle: sig
  ...
  val get_hint: string list -> string list -> (string * string) (* given a list of all the words, and a list of words the user has already found, returns a pair of strings representing a new word and the hint for it *)
